...
const TEMPLATES: TemplateConfig[] = [
  {
    ...
    icon: Users,
    color: 'utn-blue',
    description: 'Lista de aspirantes exportada desde el sistema SIGU. Incluye datos de identificación, contacto, sede, carrera, sexo y citas de matrícula. Se sube primero como base para el cruzado.',
    sheetName: 'Aspirantes',
    columns: [
      'Identificación', 'Nombre', 'Primer Apellido', 'Segundo Apellido', 'Sexo',
